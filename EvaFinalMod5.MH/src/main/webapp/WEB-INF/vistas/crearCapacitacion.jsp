...
<title>Crear Capacitacion</title>
	...
	<body>
		...
		<!-- form -->
		<form:form class="formulario" action="/crearcapacitacion" method="post" modelAttribute="formCrearCapacitacion" id="formCap">
		
			<div class="">
				<input type="hidden" class="campos-form" id="" name="idCapacitacion" placeholder="* ID capacitacion">
			</div>
