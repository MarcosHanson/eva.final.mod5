...
<html>
	...
	<body>
		...
		<form:form class="formulario" action="/crearUsurarioCliente" method="post" modelAttribute="FormUsCliente" id="FormUsCliente">
			...
			<div class="">
				 <input type="text" class="campos-form" id="rutCliente" name="rutCliente" placeholder="* Rut del cliente" value="${usuario.getUrun()}" >
			</div>	
			
			<div class="">
				 <input type="text" class="campos-form" id="cliTelefono" name="cliTelefono" placeholder="* Telefono" >
			</div>		
				
			<div class="">
				 <input type="text" class="campos-form" id="cliAFP" name="cliAFP" placeholder="* AFP" >
			</div>			
